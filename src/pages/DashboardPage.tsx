  ...
  return (
    <div className="p-4 sm:p-8 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Global Library</h1>
          <p className="text-sm sm:text-base text-slate-400">Manage and monitor your deterministic generation pipelines.</p>
        </div>
      </div>
